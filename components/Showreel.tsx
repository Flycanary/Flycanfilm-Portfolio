    ...
    <section id="showreel" className="py-24">
      ...
      >
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative w-full overflow-hidden rounded-xl shadow-2xl animate-pulse-glow-border" style={{ paddingBottom: '56.25%' /* 16:9 aspect ratio */ }}>
            <iframe
              src={PROFILE_INFO.showreelUrl}
